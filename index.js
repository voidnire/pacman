...
function animate() {
  ...
  // end detect collision ghost - player
  ...
  ghosts.forEach((ghost) => {
    ...
    // end previous ghost collisions
  })
  // end ghost collisions
